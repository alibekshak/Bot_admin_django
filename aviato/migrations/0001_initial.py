    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "photo",
                    models.CharField(
                        blank=True, max_length=3000, null=True, verbose_name="Фото"
                    ),
                ),
                (
                    "product_percent",
                    models.FloatField(
                        blank=True, null=True, verbose_name="2.5% от суммы товара"
                    ),
                ),
                (
                    "product_sum",
                    models.PositiveIntegerField(
                        blank=True, null=True, verbose_name="Сумма товара"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_id",
                    models.CharField(max_length=50, verbose_name="Айди пользователя"),
                ),
                (
                    "first_name",
                    models.CharField(
                ...
                (
                    "role",
                    models.CharField(
                        default="", max_length=200, verbose_name="Роль пользователя"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="aviato.profile",
                        verbose_name="Пользователь который активировал код",
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "checks_document",
                    models.CharField(
                        blank=True, max_length=1000, null=True, verbose_name="Чек"
                    ),
                ),
                (
                    "direction",
                ...
                (
                    "bool_status",
                    models.BooleanField(
                        blank=True, null=True, verbose_name="Подт / Отм"
                    ),
                ),
                (
                    "create_time",
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="Ожидания подтверждения",
                        max_length=200,
                        null=True,
                        verbose_name="Статус",
                    ),
                ...
                (
                    "location",
                    models.CharField(
                        blank=True, max_length=3000, null=True, verbose_name="Локация"
                    ),
                ),
                (
                    "location_time",
                    models.CharField(
                        ...
                        max_length=3000,
                        null=True,
                        verbose_name="Время локации",
                    ),
                ),
                (
                    "time_update_location",
                    models.DateTimeField(
                        auto_now=True, verbose_name="Время изменнеия локации"
                    ),
                ),
                (
                    "bool_count",
                    models.BooleanField(
                        ...
                        default=True,
                        null=True,
                        verbose_name="Хватает ли колличество",
                    ),
                ),
                (
                    "driver",
